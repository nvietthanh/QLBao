<template>
    <el-dialog v-model="dialogVisible" id="add-advertist" class="bg-[#f4f1f8] max-h-[80%] overflow-y-scroll" width="500px" 
...
export default {
    ...
    methods: {
        ...
        async addAdvertist() {
            ...
            await axios.post(route('admin.advertists.store'), pagram)
                .then(response => {
                    ElMessage({
                        showClose: true,
...
<style>
#add-advertist .el-radio {
    min-width: 220px;
    margin-top: 8px;
}
#add-advertist .el-dialog__headerbtn {
    font-size: 24px !important;
}
#add-advertist.el-dialog {
    border-radius: 4px !important;
    position: fixed !important;
    left: 0;
    right: 0;
}
#add-advertist .el-dialog__header {
    position: fixed;
    width: 500px;
...
#add-advertist .el-select,
#add-advertist .el-date-editor {
    width: 100% !important;
}
#add-advertist .el-input__inner {
    margin-top: 2px;
}
#add-advertist .creator {
    margin: 0 12px;
    padding: 0 12px;
